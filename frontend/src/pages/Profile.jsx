...
//                         <p className="font-bold text-gray-900">{displayUser.studentId}</p>
//                       </div>
//                     )}
//                     {displayUser.batch && (
//                       <div className="bg-white border-2 border-gray-200 rounded-xl p-3">
//                         <p className="text-xs text-gray-500 mb-1">Batch</p>
//                         <p className="font-bold text-gray-900">{displayUser.batch}</p>
//                       </div>
//                     )}
//                     {displayUser.batchAdvisor && (
//                       <div className="bg-white border-2 border-gray-200 rounded-xl p-3">
//                         <p className="text-xs text-gray-500 mb-1">Advisor</p>
//                         <p className="font-bold text-gray-900">{displayUser.batchAdvisor}</p>
//                       </div>
//                     )}
//                     {displayUser.batchMentor && (
//                       <div className="bg-white border-2 border-gray-200 rounded-xl p-3">
//                         <p className="text-xs text-gray-500 mb-1">Mentor</p>
//                         <p className="font-bold text-gray-900">{displayUser.batchMentor}</p>
//                       </div>
//                     )}
//                   </div>
//                 )}
