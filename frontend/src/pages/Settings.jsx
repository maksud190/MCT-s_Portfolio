...
export default function Settings() {
  ...
  const socialLinksConfig = [
    ...
    { key: 'twitter', label: 'Twitter', placeholder: 'https://twitter.com/username', icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-6 flex justify-center bg-gray-100 rounded-2xl p-4">
              ...
              >
                <img
                  ...
                  alt="Crop preview"
                  onLoad={(e) => setImageRef(e.target)}
                  style={{ maxHeight: "60vh", maxWidth: "100%", borderRadius: "12px" }}
                />
              </ReactCrop>
            </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-1 p-8">
                ...
                <div>
                  ...
                  <form onSubmit={handleUpdateProfile} className="space-y-6">
                    ...
                    <div className="text-center pb-6 border-b border-gray-200">
                      <label className="block text-sm font-bold text-gray-900 mb-4">Profile Picture</label>
                      <div className="flex flex-col items-center">
                        {avatarPreview ? (
                          <img
                            src={avatarPreview}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-sm font-bold text-gray-900 mb-2">Batch</label>
                        <input
                          type="text"
                          value={profileData.batch}
                      ...
                      <div>
                        <label className="block text-sm font-bold text-gray-900 mb-2">Batch Advisor</label>
                        <input
                          type="text"
                          value={profileData.batchAdvisor}
                          onChange={(e) => setProfileData({ ...profileData, batchAdvisor: e.target.value })}
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all text-gray-900"
                          disabled={loading}
                          placeholder="Advisor name"
                        />
                      ...
                      <div>
                        <label className="block text-sm font-bold text-gray-900 mb-2">Batch Mentor</label>
                        <input
                          type="text"
                          value={profileData.batchMentor}
                          onChange={(e) => setProfileData({ ...profileData, batchMentor: e.target.value })}
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all text-gray-900"
                          disabled={loading}
                          placeholder="Mentor name"
                        />
              ...
              {activeTab === "social" && (
                <div>
                  <h2 className="text-2xl font-black text-gray-900 mb-6">Social Links</h2>
                  <form onSubmit={handleUpdateProfile} className="space-y-6">
                    {socialLinksConfig.map(({ key, label, placeholder, icon }) => (
                      <div key={key}>
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-orange-50 border-2 border-red-200 rounded-2xl p-6">
                    ...
                    <p className="text-sm text-gray-700 mb-6">
                      Once you delete your account, there is no going back. This will permanently delete all your projects, comments, and data.
                    </p>
                    <button
                      onClick={handleDeleteAccount}
                      disabled={loading}
