                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        {question.isSolved && (
                          <span className="ml-2 px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs font-bold border border-green-200">
                            ✅ Solved
                          </span>
                        )}
                        {question.isPoll && (
                          <span className="ml-2 px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-xs font-bold border border-purple-200">
                            📊 Poll
                          </span>
                        )}
                      </div>
