  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div 
          className="w-full max-h-[90vh] bg-gray-900 rounded-3xl shadow-2xl overflow-hidden pointer-events-auto animate-slideUp"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-5">
                    ...
                    <a href={`/user/${project.userId._id}`} className="group block" onClick={handleClose}>
