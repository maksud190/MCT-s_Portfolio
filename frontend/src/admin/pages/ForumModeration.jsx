...
//                           )}
//                           {answer.isFlagged && (
//                             <span className="inline-block px-2 py-1 bg-red-100 text-red-700 text-xs font-bold rounded-full mb-2 ml-2">
//                               🚩 Flagged
//                             </span>
//                           )}
//                           <p className="text-sm text-gray-700 mb-3 line-clamp-3">{answer.content}</p>
...
//                             <div className="mt-3 p-3 bg-red-100 border-2 border-red-300 rounded-lg">
//                               <p className="text-sm font-semibold text-red-700">
//                                 <span className="font-bold">Flag Reason:</span> {answer.flagReason}
//                               </p>
//                             </div>
//                           )}
//                         </div>
