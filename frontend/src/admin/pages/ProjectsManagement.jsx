...
function FilterBar({
  ...
  return (
    <div className="mb-6 bg-stone-800 rounded-sm shadow-lg overflow-hidden">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-2.5 pl-10 text-sm border-1 border-stone-700 rounded-sm bg-stone-900 text-stone-100 hover:border-blue-400 transition-all cursor-pointer font-medium appearance-none pr-10"
                >
      ...
      <div className="bg-stone-900 px-5 py-3 border-t border-stone-700">
