      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-gray-200 dark:border-gray-700 p-6">
        <div className="flex flex-col sm:flex-row gap-4">
          <select
            ...
            className="px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-semibold focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all"
          >
            <option value="">📋 All Comments</option>
            <option value="true">🚩 Flagged Only</option>
            <option value="false">✅ Not Flagged</option>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Flag Reason */}
                  {comment.isFlagged && comment.flagReason && (
                    <div className="bg-red-100 dark:bg-red-900/20 border-2 border-red-300 dark:border-red-800 rounded-xl p-4 mb-3">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-lg hover:shadow-xl ${
                        comment.isFlagged
                          ? 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400 border-2 border-green-300'
                          : 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400 border-2 border-yellow-300'
                      }`}
                    >
                    ...
                    <button
                      onClick={() => handleDeleteComment(comment._id)}
                      className="px-5 py-2.5 bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400 rounded-xl text-sm font-bold transition-all shadow-lg hover:shadow-xl border-2 border-red-300"
                    >
                      🗑️ Delete Comment
                    </button>
                  </div>
