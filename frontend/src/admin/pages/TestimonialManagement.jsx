...
export default function TestimonialManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.role || !formData.designation || !formData.message) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Alumni</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">All Testimonials</h2>
          </div>
          ...
          {testimonials.length === 0 ? (
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              {testimonials.map((testimonial) => (
                <div key={testimonial._id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-start gap-2 mb-2">
                        ...
                        <span className={`px-2 py-1 ${getRoleBadgeColor(testimonial.role)} rounded text-xs font-semibold`}>
                          {testimonial.role}
                        </span>
