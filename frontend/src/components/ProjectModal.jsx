      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-2xl">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4 font-medium">Loading project...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div 
          className="w-full max-w-7xl max-h-[90vh] bg-white dark:bg-gray-900 rounded-3xl shadow-2xl overflow-hidden pointer-events-auto animate-slideUp"
        ...
        >
          ...
          <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 truncate max-w-md">
                {project.title}
              </h2>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl overflow-hidden">
                      ...
                      {project.images.length > 1 && (
                        <>
                          <button
                            ...
                            className="absolute left-2 top-1/2 -translate-y-1/2 p-2 bg-white/90 hover:bg-white rounded-xl shadow-xl transition-all"
                          >
                          ...
                          <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white/90 hover:bg-white rounded-xl shadow-xl transition-all"
                          >
                            <svg className="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Thumbnail Strip */}
                    {project.images.length > 1 && (
                      <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700">
                  ...
                  {/* Project Info */}
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-6 border border-blue-100 dark:border-gray-600">
                    <div className="flex items-center gap-2 mb-4">
                      <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                      </svg>
                      <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">{project.category}</span>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-3 text-center">
                      ...
                      <div className="text-xl font-black text-gray-900 dark:text-gray-100">{project.views || 0}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Views</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-3 text-center">
                      <div className="text-xl mb-1">❤️</div>
                      <div className="text-xl font-black text-gray-900 dark:text-gray-100">{likes}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Likes</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-3 text-center">
                      <div className="text-xl mb-1">📅</div>
                      <div className="text-xs font-bold text-gray-900 dark:text-gray-100">{formatDate(project.createdAt)}</div>
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-5">
                    ...
                    >
                      <div className="flex items-center gap-3 mb-3">
                        {project.userId.avatar ? (
                          <img
                            ...
                            className="w-12 h-12 rounded-xl object-cover border-2 border-gray-200 dark:border-gray-600 group-hover:border-blue-500 transition-all"
                          />
                        ) : (
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 border-2 border-gray-200 dark:border-gray-600 group-hover:border-blue-500 text-white text-lg font-bold flex items-center justify-center transition-all">
                      ...
                      <div className="flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-semibold transition-all text-sm">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-5">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-medium transition-all text-sm"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-medium transition-all text-sm"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
