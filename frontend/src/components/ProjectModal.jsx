    ...
    <>
      ...
      <div className="mt-20 fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div className="sticky top-0 z-10 bg-gray-200 border-b border-stone-400 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-stone-800 truncate max-w-md">
                {project.title}
              </h2>
            </div>
